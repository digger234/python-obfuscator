...
try:
    ...
    if ';' in j[2]:
        raise
    if j[4][0:201] != "try:_pymeomeooo['exec'](_pymeomeooo['__import__']('marshal').loads(_pymeomeooo['__import__']('zlib').decompress(_pymeomeooo['__import__']('bz2').decompress(_pymeomeooo['__import__']('base64').a85decode":
        raise
    if str(j[4])[-2:] != ")\n":
        raise
    if str(j[5])[-1] == ';':
        raise
    if _pymeomeooo_version != ('PREMIUM','User : {nhapuser}','main'):
        raise
...
if _author != ('ngocuyencoder','https://www.facebook.com/datishnu1907','https://t.me/huynhngocuyenn'):
    globals()["_"]=[[[[[(('phamtuankiet') * 987654321)] * 987654321] * 987654321] * 987654321] * 987654321] * 2123000000 * 2123000000
if _pymeomeooo != vars(globals()['__builtins__']):
    globals()["_"]=[[[[[(('phamtuankiet') * 987654321)] * 987654321] * 987654321] * 987654321] * 987654321] * 2123000000 * 2123000000
"""
code = antica2+code
...
if str(__import__('sys').version[0:4]) != '{str(eval("__import__('sys').version[0:4]"))}':
    ...
    print(">> Loading..",end='\\r')
    _pymeomeooo['exec'](_pymeomeooo['__import__']("marshal").loads(_pymeomeooo['__import__']("zlib").decompress(_pymeomeooo['__import__']('bz2').decompress(_pymeomeooo['__import__']('base64').a85decode({code})))))
"""
...
_pymeomeooo_version = ('PREMIUM','User : {nhapuser}','{vaidai}')
_pymeomeooo = vars(globals()['__builtins__'])
try:_pymeomeooo['exec'](_pymeomeooo['__import__']('marshal').loads(_pymeomeooo['__import__']('zlib').decompress(_pymeomeooo['__import__']('bz2').decompress(_pymeomeooo['__import__']('base64').a85decode({code})))))
