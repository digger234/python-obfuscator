...
try:print('\\033[96m>> Loading...\\033[0m',flush=True)
except:pass
def __concac__():print('\\033[91m>> Version mismatch! File obf at Python {sys.version_info[0]}.{sys.version_info[1]}, current '+str(sys.version_info[0])+'.'+str(sys.version_info[1])+'\\033[0m',flush=True);raise SystemExit
def __baoloi__():
 __b__=__import__('builtins');getattr(__b__,'__obsno__',0) or print('\\033[95m>> Dung co deobf em yeu a.\\033[0m',flush=True);setattr(__b__,'__obsno__',1);raise SystemExit
def __lmao__(f,*a):
...
def __depvcl__():
 ...
 __iloveyou__ and __baoloi__();core=__lmao__(__tooldepphet__);__iloveyou__ and __baoloi__();code=__lmao__(__alovu__,core);__iloveyou__ and __baoloi__();__lmao__(__nhinconcac__,code)
__depvcl__()
"""
    outer=outer.replace("(_ for _ in ()).throw(SystemExit)","1/0").replace("raise SystemExit","1/0").replace(" and 1/0"," and ((__import__('builtins').__dict__.get('__obsno__',0) or print('\\\\033[95m>> Dung co deobf em yeu a.\\\\033[0m',flush=True) or setattr(__import__('builtins'),'__obsno__',1)) and 1/0)")
